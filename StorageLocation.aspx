<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StorageLocation.aspx.cs" Inherits="StorageLocation" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td> <asp:RequiredFieldValidator ID="rfvZip" runat="server" 
                ErrorMessage="Required Field" ControlToValidate="txtZip"> </asp:RequiredFieldValidator>
        ...
        <tr>
            <td>
                <asp:Label ID="Label13" runat="server" Text="Point of Contract"></asp:Label> </td>
            <td>
        ...
        <tr>
            ...
            <td> <asp:RequiredFieldValidator ID="rfvFax" runat="server" 
                ...
                <asp:RegularExpressionValidator ID="revFax" runat="server" ControlToValidate="txtFax" ValidationExpression= "((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" ErrorMessage="Must be a valid U.S. phone number."></asp:RegularExpressionValidator>
            </td>
        </tr>
